		...
		public function recently_comment($limit, $add_where='', $select_exec_user_info=FALSE)
		{
			...
			$query = '
                        ...
                        , BBS_COMMENT.exec_user_idx
							...
							, (SELECT value FROM tb_bbs_setting WHERE bbs_idx = BBS_COMMENT.bbs_idx AND parameter = \'bbs_count_list_comment\') AS bbs_count_list_comment
							'.$add_select.'
						FROM
							tb_bbs_comment AS BBS_COMMENT
							, tb_users AS USERS
			...
			$query = $this->db->query($query, array($limit));
